...
public class Page {
	...
	private int count; // 게시글 총 갯수
	private int postNum = 10; // 한 페이지에 출력할 게시글 갯수
	private int pageNum; // 하단 페이징 번호(게시글 총 갯수 / 한 페이지에 출력할 갯수) 의 올림
	private int displayPost; // 출력할 게시글
